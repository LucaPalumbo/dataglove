...
static rosidl_typesupport_introspection_c__MessageMember dataglove_msgs__msg__VMG30Data__rosidl_typesupport_introspection_c__VMG30Data_message_member_array[7] = {
  {
    "packet_tick",  // name
    ...
    offsetof(dataglove_msgs__msg__VMG30Data, packet_tick),  // bytes offset in struct
    NULL,  // default value
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(dataglove_msgs__msg__VMG30Data, time),  // bytes offset in struct
    NULL,  // default value
    NULL,  // size() function pointer
    NULL,  // get_const(index) function pointer
    NULL,  // get(index) function pointer

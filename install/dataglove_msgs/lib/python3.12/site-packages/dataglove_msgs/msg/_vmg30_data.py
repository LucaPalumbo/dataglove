...
class VMG30Data(metaclass=Metaclass_VMG30Data):
    ...
    def __init__(self, **kwargs):
        ...
        self.packet_tick = kwargs.get('packet_tick', int())
    ...
    def __eq__(self, other):
        if not isinstance(other, self.__class__):
            return False
        if self.packet_tick != other.packet_tick:
            return False
    ...
    def packet_tick(self):
        """Message field 'packet_tick'."""
        return self._packet_tick

    @packet_tick.setter
    def packet_tick(self, value):
        if self._check_fields:
            assert \
                isinstance(value, int), \
                "The 'packet_tick' field must be of type 'int'"
            assert value >= -2147483648 and value < 2147483648, \
                "The 'packet_tick' field must be an integer in [-2147483648, 2147483647]"
        self._packet_tick = value

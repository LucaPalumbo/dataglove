...
def lwf_train(teacher, student, dataset_train, dataset_val, lambda_distill = 6.5): 
    old_classes = 2
    new_classes = 4
    ...
    early_stopping = EarlyStopping(patience=50, delta=0.001, verbose=True)  
    ...
    while True:
        ...
        if early_stopping(total_val_loss, accuracy, student, 'distillated_checkpoint.pt'):
...
def main():
    ...
    dataset_train = GloveDataset("/home/feld/ros2_ws/src/model/dataset/train", ["pen", "phone"])
    dataset_val = GloveDataset("/home/feld/ros2_ws/src/model/dataset/validation", ["pen", "phone"])

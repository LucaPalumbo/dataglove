...
if __name__ == "__main__":
    ...
    parser.add_argument('--split', action="store_true", help='Whether to split the dataset into train, validation, and test sets')
    parser.add_argument('--k', type=int, default=0, help='K for k-fold cross-validation')

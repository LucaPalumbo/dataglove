...
def lwf_train(teacher, student, dataset_train, dataset_val, lambda_distill = 10, warm_up=False): 
    old_classes = 4
    ...
    early_stopping = EarlyStopping(patience=20, delta=0.0006, verbose=True)
...
def main():
    ...
    dataset_val = GloveDataset("/home/feld/ros2_ws/datasets/dataset_merged2/validation", ["mouse", "glasses"])

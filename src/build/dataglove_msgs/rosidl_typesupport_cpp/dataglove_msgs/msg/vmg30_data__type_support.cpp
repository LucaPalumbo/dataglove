...
static const _VMG30Data_type_support_symbol_names_t _VMG30Data_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, dataglove_msgs, msg, VMG30Data)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, dataglove_msgs, msg, VMG30Data)),
  }
};
...
{
  return &::dataglove_msgs::msg::rosidl_typesupport_cpp::VMG30Data_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, dataglove_msgs, msg, VMG30Data)() {
  return get_message_type_support_handle<dataglove_msgs::msg::VMG30Data>();
}

...
#include "dataglove_msgs/msg/detail/vmg30_data__rosidl_typesupport_fastrtps_cpp.hpp"
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  // Member: rpy_hand
  {
    cdr << ros_message.rpy_hand;
  }

  // Member: quat_hand
  {
    cdr << ros_message.quat_hand;
  }

  // Member: rpy_forearm
  {
    cdr << ros_message.rpy_forearm;
  }

  // Member: quat_forearm
  {
    cdr << ros_message.quat_forearm;
  }
  ...
  size_t current_alignment)
{
  ...
  // Member: sensors
  {
    ...
    size_t item_size = sizeof(ros_message.sensors[0]);
  ...
  // Member: rpy_hand
  {
    ...
    current_alignment += padding +
      eprosima::fastcdr::Cdr::alignment(current_alignment, padding);
    size_t item_size = sizeof(ros_message.rpy_hand[0]);
    current_alignment += array_size * item_size +
      eprosima::fastcdr::Cdr::alignment(current_alignment, item_size);
  }
  ...
  // Member: quat_hand
  {
    ...
    current_alignment += padding +
      eprosima::fastcdr::Cdr::alignment(current_alignment, padding);
    size_t item_size = sizeof(ros_message.quat_hand[0]);
    current_alignment += array_size * item_size +
      eprosima::fastcdr::Cdr::alignment(current_alignment, item_size);
  }
  ...
  // Member: rpy_forearm
  {
    ...
    current_alignment += padding +
      eprosima::fastcdr::Cdr::alignment(current_alignment, padding);
    size_t item_size = sizeof(ros_message.rpy_forearm[0]);
    current_alignment += array_size * item_size +
      eprosima::fastcdr::Cdr::alignment(current_alignment, item_size);
  }
  ...
  // Member: quat_forearm
  {
    ...
    current_alignment += padding +
      eprosima::fastcdr::Cdr::alignment(current_alignment, padding);
    size_t item_size = sizeof(ros_message.quat_forearm[0]);
    current_alignment += array_size * item_size +
      eprosima::fastcdr::Cdr::alignment(current_alignment, item_size);
  }
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = dataglove_msgs::msg::VMG30Data;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const dataglove_msgs::msg::VMG30Data *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<dataglove_msgs::msg::VMG30Data *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}

static uint32_t _VMG30Data__get_serialized_size(
  const void * untyped_ros_message)
{
  auto typed_message =
    static_cast<const dataglove_msgs::msg::VMG30Data *>(
...
static size_t _VMG30Data__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_VMG30Data(full_bounded, is_plain, 0);
...
static message_type_support_callbacks_t _VMG30Data__callbacks = {
  "dataglove_msgs::msg",
  "VMG30Data",
...
static rosidl_message_type_support_t _VMG30Data__handle = {
  rosidl_typesupport_fastrtps_cpp::typesupport_identifier,
  &_VMG30Data__callbacks,
...
template<>
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_EXPORT_dataglove_msgs
const rosidl_message_type_support_t *
get_message_type_support_handle<dataglove_msgs::msg::VMG30Data>()
{
  return &dataglove_msgs::msg::typesupport_fastrtps_cpp::_VMG30Data__handle;
}
